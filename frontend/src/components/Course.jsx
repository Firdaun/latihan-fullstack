    ...
    return (
        <div className="mt-20">
            <div className="flex flex-col items-center py-20 bg-white">
                <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900">Reference</h1>
                <p className="text-lg lg:text-2xl font-semibold text-gray-600 mt-2">Referensi pembelajaran</p>
            </div>
