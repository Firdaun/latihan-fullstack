                ...
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {componentsFooter.map((column, columnIndex) => (
                            <div key={columnIndex}>
                                <h3 className="text-lg font-semibold text-white mb-4 border-b border-gray-700 pb-2">{column.name}</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-white mb-4 border-b border-gray-700 pb-2">HUBUNGI KAMI</h3>
