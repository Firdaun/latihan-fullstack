            ...
            {!isUnlocked && (
                <div className="fixed backdrop-blur-sm inset-0 bg-black/70 z-9999 w-screen h-screen flex justify-center items-center">
                    <form
                        ...
                        className="bg-white relative w-11/12 sm:max-w-lg md:max-w-2xl p-6 md:p-10 md:shadow-xl rounded-2xl md:border border-blue-200 transform transition-all duration-500">
